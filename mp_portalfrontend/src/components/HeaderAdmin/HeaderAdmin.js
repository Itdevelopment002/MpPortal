...
const HeaderAdmin = () => {
    ...
    useEffect(() => {
        ...
        if (storedUser && storedUser.username) {
            setUsername(storedUser.username); // Set the username dynamically
        }
    }, []);


    const onLogout = () => {
        // Remove 'isLoggedIn' from localStorage to log out the user
                        ...
                        <div className="main-header-dropdown dropdown-menu dropdown-menu-end">
                            <div className="p-3">
                                <div className="d-flex align-items-center justify-content-between">
                                    ...
                                    <span className="badge bg-secondary text-fixed-white">{unreadCount} Unread</span>
                                </div>
                            </div>
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                            <li>
                                <div class="dropdown-item text-center border-bottom">
                                    ...
                                    <span className="d-block fs-12 text-muted">{username?.designation || "Designation"}</span>
                                </div>
                            </li>
                            ...
                            <li>
                                <Link
                                    to="/login" // This will be handled by navigate inside the onLogout function
